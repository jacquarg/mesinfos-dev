...
buf.push("<nav class=\"typologies navbar navbar-default\"></nav><div class=\"message\"></div><div class=\"documentation\"></div><div class=\"row\"><div class=\"dsviewshistory col-xs-3\"></div><div class=\"requestform col-xs-4\"></div><div class=\"documents col-xs-5\"></div></div>");;return buf.join("");
};
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (Description, DocType, Fréquence, Latence, Nom, docType, subsets, synthSetInDS, synthSetInsertable, undefined) {
buf.push("<div class=\"toggle\"><h4>" + (jade.escape(null == (jade_interp = Nom) ? "" : jade_interp)) + "</h4></div>");
...
buf.push("<div class=\"subset\"><p>" + (jade.escape(null == (jade_interp = Description) ? "" : jade_interp)) + "</p><ul class=\"caracteristiques\"><li><b>Fréquence :&nbsp;</b>" + (jade.escape(null == (jade_interp = Fréquence) ? "" : jade_interp)) + "</li><li><b>Latence :&nbsp;</b>" + (jade.escape(null == (jade_interp = Latence) ? "" : jade_interp)) + "</li></ul></div><div class=\"doctype\"><h5>DocType :&nbsp;" + (jade.escape(null == (jade_interp = docType.Nom) ? "" : jade_interp)) + "</h5><p>" + (jade.escape(null == (jade_interp = docType.Description) ? "" : jade_interp)) + "</p><div class=\"similaires\"><h6>Du même type :</h6><ul>");
// iterate subsets
;(function(){
  var $$obj = subsets;
...
buf.push("<li><a" + (jade.attr("href", '?DocType=' + DocType + '#' + s.Nom, true, false)) + ">" + (jade.escape(null == (jade_interp = s.Nom) ? "" : jade_interp)) + "</a></li>");
    }
...
buf.push("<h4 class=\"subset\"><span class=\"name\">" + (jade.escape(null == (jade_interp = Nom) ? "" : jade_interp)) + "</span><img" + (jade.attr("src", 'img/holders/logo_' + Détenteur.toLowerCase() + '.png', true, false)) + (jade.attr("title", Détenteur, true, false)) + "/></h4>");}.call(this,"Détenteur" in locals_for_with?locals_for_with.Détenteur:typeof Détenteur!=="undefined"?Détenteur:undefined,"Nom" in locals_for_with?locals_for_with.Nom:typeof Nom!=="undefined"?Nom:undefined));;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
...
buf.push("<div class=\"navbar-header\">MesInfos</div><div class=\"collapse navbar-collapse\"><ul class=\"typologies nav navbar-nav\"></ul></div>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
